...
def generate_oss_test_case(ct: int = 50):
    ...
    jsonl_file_name = "training_dataset/oss/data/v2.jsonl"
    start_idx = 0
    try:
    ...
    # preparing the input
    data = load_jsonl("training_dataset/oss/data/v1.jsonl")
    if ct > 0:
        data = data[:ct]
    data = data[start_idx:]
